...
class MainWindow(QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Дата рождения"))
        self.pushButton_1.setText(_translate("MainWindow", "AB"))
        self.pushButton_2.setText(_translate("MainWindow", "CD"))
        self.pushButton_3.setText(_translate("MainWindow", "EF"))
        self.pushButton_4.setText(_translate("MainWindow", "GHIJ"))
        self.pushButton_5.setText(_translate("MainWindow", "KL"))
        self.pushButton_6.setText(_translate("MainWindow", "MN"))
        self.pushButton_7.setText(_translate("MainWindow", "OP"))
        self.pushButton_8.setText(_translate("MainWindow", "QR"))
        self.pushButton_9.setText(_translate("MainWindow", "ST"))
        self.pushButton_10.setText(_translate("MainWindow", "UV"))
        self.pushButton_11.setText(_translate("MainWindow", "WXYZ"))
