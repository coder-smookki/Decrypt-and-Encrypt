...
# Функции выполнения всех параметров для входа
def log_in():
    cursor = connection.cursor()
...
# Выполнение всех кнопок и прочее
def actions():
